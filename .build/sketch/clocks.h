#line 1 "c:\\Users\\Dellus\\Documents\\Arduino\\ClockForgeOS\\clocks.h"
  /*
 ******************* CLOCK DEFINITIONS ***********************
...
//______________________ESP-32 CLOCKS  (2x20pin ESP32 D1 mini modul) ______________________________________________________
...
#ifdef CLOCK_49   //ESP32, UNFI  SN75518 6xIV-11 clock
  #define DEBUG 
  #define FW "fw49"  //firmware name
  #define MAXBRIGHTNESS 100    
  #define USE_NEOPIXEL 
  #define NEOPIXEL_PIN 26               // flat 26/17
  byte tubePixels[] = {0,1,2,3,4,5};    //6 tubes, single leds
  //#define USE_DALLAS_TEMP
  //#define TEMP_DALLAS_PIN 22          //23/22 Dallas temp sensor pin.  SET TO -1    
  //#define USE_DHT_TEMP
  //#define DHTTYPE DHT11
  //#define TEMP_DHT_PIN 23     //23/22 DHT temp sensor pin.  If not used, SET TO -1
  //#define USE_GPS
  #define USE_RTC
  #define USE_MQTT
  #define USE_BME280            //I2C Temperature + humidity + pressure
  ...
  //Segments:  abcdefgdp  
  #define SEGMENT8 
  //byte segmentEnablePins[] =  {1,2,3,4,5,6,7,8};         //IV-6 segment enable OUTbits of SN75518 (a,b,c,d,e,f,g,h)
  //byte digitEnablePins[] =    {23,25,27,22,20,18};       //IV-6 digit enable OUTbits of SN75518 (1,2,3,4,5,6)
  //byte segmentEnablePins[] =  {23,20,7,8,27,25,18,22};   //IV-11 segment enable OUTbits of SN75518 (a,b,c,d,e,f,g,h)
  //byte digitEnablePins[] =    {6,5,4,3,2,1};             //IV-11 digit enable OUTbits of SN75518 (1,2,3,4,5,6)
  byte segmentEnablePins[] =  {17,18,19,20,21,22,23,24};   //IV-11 segment enable OUTbits of SN75518   (flat, old)
  byte digitEnablePins[] =    {27,28,29,30,31,32};         //IV-11 digit enable OUTbits of SN75518 (1,2,3,4,5,6)  (flat, old)  
  ...
  //byte segmentEnablePins[] =  {1,7,3,2,5,4,8,6};         //IV-22 segment enable OUTbits of SN75518   (You MUST define  8 Pins!!!)
  //byte digitEnablePins[] =    {23,25,27,22,20,18};       //IV-22 digit enable OUTbits of SN75518 (1,2,3,4,5,6)  (MP1---Ó10)
  #define DOUBLE_BLINK     //both separator points are blinking 
  //SN75518 pins
  #define PIN_LE    13          //old/new 13/5 Shift Register Latch Enable
  #define PIN_CLK   12          //old/new 12/23 Shift Register Clock
  #define PIN_DATA  27          //old/new 27/18 Shift Register Data
  #define PIN_STB   14          //old/new 14/19 Shift Register Strobe
  #define ALARMSPEAKER_PIN 19   //19/16 Alarm buzzer pin                                           
  #define ALARMBUTTON_PIN 33    //33/0 Alarm switch off button 
...
#ifdef CLOCK_51   //V2  ESP32, UNFI 2xHV5122 PCB version, 6xZ573M clock   Example clock!!! Z574m
  #define DEBUG 
...
//___________________________________________________________________________________    
  ...
  #define ALARM_ON HIGH         //How to switch ON alarm buzzer
  // Schematic: ALARM/Radar input is wired to GPIO19 on this PCB.
  #define RADAR_PIN 18
  #define RADAR_TIMEOUT 5  //min
  //#define TUBE_POWER_PIN 4
  #define TUBE_POWER_ON  HIGH
...
//__________________________________________________________________________________________________      
  ...
  #define GRAD_CHARCODE 10 
  #define PERCENT_CHARCODE 10
  #define AP_NAME "UNIFICLOCK"
  #define AP_PASSWORD "" 
  #define WEBNAME "UNIFI Nixie Clock HV5122"
  //#define DEFAULT_SSID ""
  //#define DEFAULT_PSW ""
  //#define USE_WIFIMANAGER
  //#define DISABLE_NIGHT_ANIMATION  
...
#ifdef CLOCK_64   //V2  ESP32, UNFI 2xHV5122 PCB version, 6xZ574M clock   Example clock!!!
  #define DEBUG 
  #define FW "fw64"  //firmware name
  #define MAXBRIGHTNESS 100    
  #define USE_NEOPIXEL
  #define NEOPIXEL_PIN 27
  #define USE_RTC
